...
public class SeckillActivityController {
    ...
    @RequestMapping("/addSeckillActivity") //post page
    ...
    public ModelAndView seckillCommodity(@PathVariable long userId, @PathVariable long seckillActivityId) {
        ...
        try {
             ...
             * 确认是否能够进行秒杀
             */
            stockValidateResult = seckillActivityService.seckillStockValidator(seckillActivityId); //Lua script determine available stock
            if (stockValidateResult) {
                Order order = seckillActivityService.createOrder(seckillActivityId, userId);// create items
